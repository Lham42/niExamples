...
int main(void)
{
	...
	/*********************************************/
	DAQmxErrChk (DAQmxConfigureLogging(taskHandle,"C:\\Users\\Public\\Documents\\National Instruments\\NI-DAQ\\Examples\\DAQmx ANSI C\\Analog In\\Measure Voltage\\TDMS-Acq-Int Clk\\example.tdms",DAQmx_Val_LogAndRead,"GroupName",DAQmx_Val_OpenOrCreate));
